...
export default function PostOfficeScreen({ navigation }) {
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Post Office</Text>
            </View>
            <View style={styles.content}>
                <Text style={styles.placeholderText}>Post Office Screen</Text>
